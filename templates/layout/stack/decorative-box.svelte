...
<div
	class={twMerge(
		"flex items-center justify-center rounded-(--radius-l2) border",
		// Light/Dark Mode using semantic tokens
		"bg-(--color-bg-emphasized) border-(--color-border-default) text-(--color-fg-default)",
		// Dot Pattern Effect
