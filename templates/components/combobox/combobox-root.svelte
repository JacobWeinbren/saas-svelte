<script module lang="ts">
	...
	export const combobox = tv({
		slots: {
			...
			label: [
				"text-fg-default font-(--font-weights-medium)",
			...
			itemGroupLabel: [
				"flex items-center",
				"text-fg-muted font-(--font-weights-medium)",
				"select-none",
			],
			empty: [
				"flex items-center justify-center",
		...
		variants: {
			size: {
				xs: {
					input: "h-6 px-2 rounded-sm text-(length:--font-sizes-xs) leading-(--line-heights-xs)",
					indicatorGroup: "gap-1 px-2",
					trigger: "size-3.5 [&_svg]:size-3.5",
					clearTrigger: "size-3.5 [&_svg]:size-3.5",
					content: "rounded-sm p-0.5",
					item: "h-5 py-0.5 px-1 gap-1 rounded-xs text-(length:--font-sizes-xs) leading-(--line-heights-xs)",
					itemGroupLabel: "min-h-5 px-1 text-(length:--font-sizes-xs) leading-(--line-heights-xs)",
					startElement: "px-2 [&_svg]:size-3",
				},
				sm: {
					input: "h-7 px-2.5 rounded-sm text-(length:--font-sizes-sm) leading-(--line-heights-sm)",
					indicatorGroup: "gap-1 px-2.5",
					trigger: "size-4 [&_svg]:size-4",
					clearTrigger: "size-4 [&_svg]:size-4",
					content: "rounded-md p-1",
					item: "h-6 py-1 px-1.5 gap-1.5 rounded-sm text-(length:--font-sizes-xs) leading-(--line-heights-xs)",
					itemGroupLabel: "min-h-6 px-1.5 text-(length:--font-sizes-xs) leading-(--line-heights-xs)",
					startElement: "px-2.5 [&_svg]:size-3.5",
				},
				md: {
					input: "h-8 px-3 rounded-sm text-(length:--font-sizes-sm) leading-(--line-heights-sm)",
					indicatorGroup: "gap-1 px-3",
					trigger: "size-4 [&_svg]:size-4",
					clearTrigger: "size-4 [&_svg]:size-4",
					content: "rounded-lg p-1",
					item: "h-7.5 py-1.5 px-2 gap-2 rounded-sm text-(length:--font-sizes-sm) leading-(--line-heights-sm)",
					itemGroupLabel: "min-h-7.5 px-2 text-(length:--font-sizes-sm) leading-(--line-heights-sm)",
					startElement: "px-3 [&_svg]:size-4",
				},
				lg: {
					input: "h-10 px-4 rounded-sm text-(length:--font-sizes-md) leading-(--line-heights-md)",
					indicatorGroup: "gap-1 px-4",
					trigger: "size-5 [&_svg]:size-5",
					clearTrigger: "size-5 [&_svg]:size-5",
					content: "rounded-lg p-1",
					item: "h-9 py-2 px-3 gap-2 rounded-sm text-(length:--font-sizes-md) leading-(--line-heights-md)",
					itemGroupLabel: "min-h-9 px-3 text-(length:--font-sizes-md) leading-(--line-heights-md)",
