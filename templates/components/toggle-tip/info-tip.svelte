...
>
	<button
		...
		class="inline-flex items-center justify-center align-middle p-0 border-0 bg-transparent h-4 w-4 cursor-pointer rounded-l1 outline-0 transition-[color,background-color] duration-moderate hover:bg-bg-subtle focus-visible:outline-offset-2 focus-visible:outline-1 focus-visible:outline-solid focus-visible:outline-border-emphasized"
	>
