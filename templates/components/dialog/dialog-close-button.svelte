...
<Dialog.CloseTrigger
	class={twMerge(
		// Position & Shape
		"absolute right-(--spacing-4) top-(--spacing-4) rounded-(--radius-md) transition-colors cursor-(--cursor-button) min-w-(--spacing-7) h-(--spacing-7)",
		// Layout
		...
		// Focus ring
		"focus-visible:outline-1 focus-visible:outline-offset-[var(--spacing-0_5)] focus-visible:outline-solid focus-visible:outline-fg-default",
		// Disabled state
