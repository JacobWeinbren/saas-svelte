...
<ArgTypes {...getControls(['variant', 'size', 'orientation', 'collapsible', 'multiple', 'defaultValue', 'class', 'children'])} />

**AccordionItem**

<ArgTypes {...getControls(['value', 'disabled', 'class', 'children'])} />

**AccordionItemTrigger**

<ArgTypes {...getControls(['icon', 'class', 'children'])} />

**AccordionItemContent**

<ArgTypes {...getControls(['class', 'children'])} />
