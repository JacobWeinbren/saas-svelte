<script module lang="ts">
	...
	const { Story } = defineMeta({
		...
		parameters: {
			controls: getControls(["variant", "position", "bordered", "colour", "class"]),
		},
		args: {
			variant: "default",
			position: "static",
...
<Story name="Glass Variant" template={glassStory} parameters={{ docs: { story: { inline: true } } }} />

<Story name="Solid Variant" template={solidStory} parameters={{ docs: { story: { inline: true } } }} />

<Story name="Variants" template={variantsStory} parameters={{ docs: { story: { inline: true } } }} />

<Story name="Sticky" template={stickyStory} parameters={{ docs: { story: { inline: true } } }} />
